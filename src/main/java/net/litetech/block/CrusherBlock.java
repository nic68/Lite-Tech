...
import net.litetech.gui.CrusherGuiGui;
...
public class CrusherBlock extends LiteTechElements.ModElement {
	@ObjectHolder("litetech:crusher")
	public static final Block block = null;
	@ObjectHolder("litetech:crusher")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public CrusherBlock(LiteTechElements instance) {
		super(instance, 3);
