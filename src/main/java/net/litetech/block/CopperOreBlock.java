...
public class CopperOreBlock extends LiteTechElements.ModElement {
	@ObjectHolder("litetech:copperore")
	public static final Block block = null;
	public CopperOreBlock(LiteTechElements instance) {
		super(instance, 37);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}), block.getDefaultState(), 22), Placement.COUNT_RANGE, new CountRangeConfig(14, 2, 2, 80)));
		}
	}
}
